        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <img
              src={image}
              alt=""
              className="block object-cover object-center w-full rounded-md h-96 dark:bg-gray-500"
            />
          </div>
          <div className="space-y-2">
            ...
            <p className="leading-snug dark:text-gray-900">{description}</p>
          </div>
            ...
            <div className="flex flex-col items-center w-full">
              ...
              <form onSubmit={handleReview} className="flex flex-col w-full">
                <input
                  ...
                  name="message"
                  placeholder="Message..."
                  className="p-4 rounded-md resize-none dark:text-gray-900 dark:bg-gray-200"
                ></input>
                <button
                  type="submit"
